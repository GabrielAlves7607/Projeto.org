...
button = tk.Button(root, text="Botão 1", fg="white", bg="#3b3b3b", font=("Arial", 12))
button.place(x=50, y=25)

button = tk.Button(root, text="Botão 2", fg="white", bg="#3b3b3b", font=("Arial", 12))
button.place(x=125, y=25)

button = tk.Button(root, text="Botão 3", fg="white", bg="#3b3b3b", font=("Arial", 12))
button.place(x=200, y=25)

button = tk.Button(root, text="Botão 4", fg="white", bg="#3b3b3b", font=("Arial", 12))
button.place(x=275, y=25)
